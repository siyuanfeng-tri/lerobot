...
from lerobot.common.datasets.spartan.pytorch_util import dict_apply
from lerobot.common.datasets.spartan.dict_of_tensor_mixin import (
    DictOfTensorMixin,
)
...
def add_identity_normalizer_for_images(
...
def create_normalizer_with_identity(shape_meta: Dict) -> LinearNormalizer:
    ...
    normalizer = add_identity_normalizer_for_images(normalizer, camera_names)
    return normalizer
